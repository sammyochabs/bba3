...
const GeneralTab = ({ handleInput, data }) => {
  return (
    <CTabPane>
      <CCard>
        <CCardHeader>
            ...
            <CFormGroup row>
              ...
              <CCol xs="12" md="9">
                <CSelect
                  ...
                  value={data?.general_employee_blood}
                  id="select"
            ...
            <CFormGroup row>
              ...
              <CCol xs="12" md="9">
                <CSelect
                  ...
                  value={data?.general_employee_religion}
                  id="select"
                  onChange={handleInput}
                >
            ...
            <CFormGroup row>
              ...
              <CCol xs="12" md="9">
                <CSelect
                  ...
                  value={data?.general_employee_gender}
                  id="select"
                  onChange={handleInput}
                >
            ...
            <CFormGroup row>
              ...
              <CCol xs="12" md="9">
                <CSelect
                  ...
                  value={data?.general_employee_nationality}
                  id="select"
                  onChange={handleInput}
                >
