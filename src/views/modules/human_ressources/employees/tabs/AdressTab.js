...
const AdressTab = ({ handleInput, data }) => {
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CInput
                      ...
                      value={data?.present_adress_village_house}
                      placeholder="Adress"
                      autoComplete="vilage"
                    />
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CInput
                      ...
                      value={data?.present_adress_post_office}
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CInput
                      ...
                      value={data?.present_adress_upazila}
                      placeholder="Upazila"
                    />
                    <CFormText className="help-block"></CFormText>
                  </CCol>
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CSelect
                      ...
                      value={data?.present_adress_district}
                      id="select"
                    >
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CInput
                      ...
                      value={data?.permanent_adress_village_house}
                      placeholder="Adress"
                      autoComplete="vilage"
                    />
                    <CFormText className="help-block"></CFormText>
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CInput
                      ...
                      value={data?.permanent_adress_post_office}
                      placeholder="Post office "
                      autoComplete="post"
                    />
                    <CFormText className="help-block"></CFormText>
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CInput
                      ...
                      value={data?.permanent_adress_upazila}
                      placeholder="Upazila"
                    />
                    <CFormText className="help-block"></CFormText>
                  </CCol>
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CSelect
                      ...
                      value={data?.permanent_adress_district}
                      id="select"
                    >
                      <option>Please select district</option>
                      {renderDistricts}
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CInput
                      ...
                      value={data?.official_adress_village_house}
                      placeholder="Adress"
                      autoComplete="vilage"
                    />
                    <CFormText className="help-block"></CFormText>
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CInput
                      ...
                      value={data?.official_adress_post_office}
                      placeholder="Post office "
                      autoComplete="post"
                    />
                    <CFormText className="help-block"></CFormText>
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CInput
                      ...
                      value={data?.official_adress_upazila}
                      placeholder="Upazila"
                    />
                    <CFormText className="help-block"></CFormText>
                  </CCol>
                ...
                <CFormGroup row>
                  ...
                  <CCol xs="12" md="9">
                    <CSelect
                      ...
                      value={data?.official_adress_district}
                      id="select"
                    >
                      <option>Please select district</option>
                      {renderDistricts}
